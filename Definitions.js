			...
			const preloaded = ["plants/cherry bomb","plants/wall nut","proj/explosion","proj/ice","proj/sun","ui/grave","ui/hole","zombies/flag"]
			let preloadedImg = []
			preloaded.forEach((e) => {
				...
				//Levels
			const Unlocks = [0,1,2,3,-1,4,5,6,7,-1,8,9,10,11,-1,12,13,14,15,-1,-1]
			...
			const conveyors = {4:[2,3],9:[0,2,3,4,5,6,7],19:[8,10,11,12,13,14,15]}
				//Plants
			//const plants = [["🫛"],["🌻"],["🍒"],["🌰"],["🥔"],["❄️"],["🟣","👄"],["🫛","🫛"],["🍄"],["🍄‍🟫"],["🍄"],["🪵"],["🍄","","","🩷","🩵"],["🍄","","👁️"],["🍄","❄️"],["🍄","💣"]]
			const plants = ["peashooter","sunflower","cherry bomb","wall nut","potato mine unarmed","iceberg lettuce","chomper","repeater","puff shroom","sun shroom small","fume shroom","grave buster","hypno shroom","scaredy shroom","ice shroom","doom shroom"]
			...
			const ProjImg = ["pea","sun","explosion","","explosion","ice","","pea","spore","sun","fume","","","spore","ice","explosion"]
